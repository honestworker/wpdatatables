        ...
        _buildButton: function(a, b) {
            ...
            var r = function(a, b, c, e) {
                ...
                k = d("<" + c.tag + "/>").addClass(c.className).attr("tabindex", this.s.dt.settings()[0].iTabIndex).attr("aria-controls", this.s.dt.table().node().id).on("click.dtb", function(b) {
                    b.preventDefault();
                    if (a.namespace == '.dt-button-0') {
                        var oldLength = $('.selectpicker').val();
                        $('.selectpicker').val('-1').trigger('change');
                        setTimeout(function(){
                            !k.hasClass(c.disabled) && a.action && r(b, h, k, a);
                            k.blur();
                            $('.selectpicker').val(oldLength).trigger('change');
                        }, 5000);
                    } else {
                        !k.hasClass(c.disabled) && a.action && r(b, h, k, a);
                        k.blur();
...
(function(i) {
    ...
    n.ext.buttons.excelHtml5 = {
        ...
        action: function(a, c, d, b) {
                ...
                m, l, d = function(a) {
                    ...
                    for (var b1 = 0, c1 = a1.length; b1 < c1; b1++) {
                        ...
                        if (!(null === a1[b1] || a1[b1] === o || "" === a1[b1])) {
                            ...
                            (b1 == 7 && g > 999) && (e = 999), (b1 == 4 || b1 == 5) && (e = e.replace(',', '.')),
                            g = p(f1, "c", {
                                attr: {
                                    t: "inlineStr",
                                    r: d1
            ...
            ////////////////////////////
            ////////////////////////////
            var c_header1 = ["Automate Pricing-1.0", "The top 3 rows are for Amazon use only. Do not modify or delete the top 3 rows"];
            var c_header2 = ["SKU", "Minimum Seller Allowed Price", "Maximum Seller Allowed Price", "Rule Name", "Rule Action"];
            var c_header3 = ["sku", "minimum-seller-allowed-price", "maximum-seller-allowed-price", "rule-name", "rule-action"];
            b2.customizeData && b2.customizeData(c2);
            b2.header && (d2(c_header1, h2), i("row c", f2).attr("s", "2"));
            b2.header && (d2(c_header2, h2), i("row c", f2).attr("s", "2"));
            b2.header && (d2(c_header3, h2), i("row c", f2).attr("s", "2"));
            for (var k = 0, n = c2.body.length; k < n; k++) {
                var c_body = [];
                for (var k1 = 0, n1 = c_header3.length; k1 < n1; k1++) {
                    if (k1 == 0) {
                        ...
                        else if (c2.body[k].length >= k1 + 10) {
...
function wdtRemoveOverlay(table_selector) {
    if (jQuery('.selectpicker')) {
        jQuery('.selectpicker').removeClass('exporting');
    }
